...
import com.example.ngoquan.demogooglemap.util.Constants;
...
//        mMap = mapFragment.getMap();
    ...
    protected void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.ngoquan.demogooglemap/http/host/path")
        );
...
//        Calculating the distance in metter direction straight line
//        Double distance = SphericalUtil.computeDistanceBetween(from, to);

        //Displaying the distance
//        Toast.makeText(this, String.valueOf(distance/1000f + " Meters"), Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "Distance: " + distOb.getString("text") + ", Time: " + timeOb.getString("text"), Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(MainActivity.this, address.get(0).getLatitude() + " - " + address.get(0).getLongitude(), Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MainActivity.this, "Địa chỉ bạn nhập không đúng...!", Toast.LENGTH_SHORT).show();
                        }
                } catch (IOException e) {
                    e.printStackTrace();
                }
...
//        ed_address = (EditText) findViewById(R.id.ed_address);
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        Log.e("MarkerPlace", marker.getSnippet().toString());
        return false;
    }

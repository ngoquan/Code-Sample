 ...
 */
public class SpinnerNgonNguAdapter extends ArrayAdapter<NgonNgu_ett> {
    private Activity activity;
    private int layout;
    private ArrayList<NgonNgu_ett> arrData = new ArrayList<>();
    public SpinnerNgonNguAdapter(Activity activity, int layout, ArrayList<NgonNgu_ett> arrData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        NgonNgu_ett ngonNgu_ett = arrData.get(position);
        if (convertView == null)
        ...
        txt_value.setText(ngonNgu_ett.getMaNN() + " - " + ngonNgu_ett.getTenNN());
        return convertView;
    }

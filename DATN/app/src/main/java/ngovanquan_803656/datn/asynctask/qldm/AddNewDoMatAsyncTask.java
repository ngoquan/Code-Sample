 ...
 */
public class AddNewDoMatAsyncTask extends AsyncTask<Void, Void, DoMat_ett> {
    ...
    public AddNewDoMatAsyncTask(Activity activity, String TenDoMat, String GhiChu, int STT, boolean Active) {
    ...
    protected DoMat_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Insert_DoMat";

 ...
 */
public class AddNewTTVLAsyncTask extends AsyncTask<Void, Void, TTVL_ett> {
    ...
    public AddNewTTVLAsyncTask(Activity activity, String TenTTVL, String GhiChu, int STT, boolean Active) {
    ...
    protected TTVL_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Insert_TTVL";

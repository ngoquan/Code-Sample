 ...
 */
public class SearchVanBanByHSSoAndSKHVB extends AsyncTask<Void, Void, ArrayList<VanBan_ett>> {

    private Activity activity;
    private ProgressDialog progressDialog;
    private String hoSoSo, soKHVB;
    private int page_current;
    private ArrayList<VanBan_ett> arrVanBan = new ArrayList<>();

    public SearchVanBanByHSSoAndSKHVB(Activity activity, String hoSoSo, String soKHVB, int page_current) {

...
/**
 * Created by NGOQUAN on 6/12/2016.
 */
public class SearchHoSoByIDAndHopHoSoID extends AsyncTask<Void, Void, ArrayList<HoSo_ett>> {

    private Activity activity;
    private String hoSoSo, maHopHS;
    private int pageCurrent, num_row_per_page;
    private ProgressDialog progressDialog;
    private ArrayList<HoSo_ett> arrData = new ArrayList<>();

    public SearchHoSoByIDAndHopHoSoID(Activity activity, String hoSoSo, String maHopHS, int pageCurrent, int num_row_per_page) {

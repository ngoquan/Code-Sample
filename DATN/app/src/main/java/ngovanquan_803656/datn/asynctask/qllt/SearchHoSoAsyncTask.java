...
/**
 * Created by ngoquan on 5/13/2016.
 */
public class SearchHoSoAsyncTask extends AsyncTask<Void, Void, ArrayList<HoSo_ett>> {
    ...
    public SearchHoSoAsyncTask(Activity activity, String search_type, String search_val, int pageCurrent, int num_row_per_page) {

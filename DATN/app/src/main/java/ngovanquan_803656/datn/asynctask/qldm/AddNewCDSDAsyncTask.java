 ...
 */
public class AddNewCDSDAsyncTask extends AsyncTask<Void, Void, CDSD_ett> {
    ...
    public AddNewCDSDAsyncTask(Activity activity, String TenCDSD, String GhiChu, int STT, boolean Active) {
    ...
    protected CDSD_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Insert_CDSD";

 ...
 */
public class AddNewTHBQAsyncTask extends AsyncTask<Void, Void, THBQ_ett> {
    ...
    public AddNewTHBQAsyncTask(Activity activity, String TenTHBQ, String GhiChu, int STT, boolean Active) {
    ...
    @Override
    protected void onPostExecute(THBQ_ett cdsd_ett) {
    ...
    protected THBQ_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Insert_THBQ";

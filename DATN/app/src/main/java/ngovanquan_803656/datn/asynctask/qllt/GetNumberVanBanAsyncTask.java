 ...
 */
public class GetNumberVanBanAsyncTask extends AsyncTask<Void, Void, Integer> {
...
//    private ProgressDialog progressDialog;
    ...
    public GetNumberVanBanAsyncTask(Activity activity, String search_type, String search_val, int pageCurrent) {

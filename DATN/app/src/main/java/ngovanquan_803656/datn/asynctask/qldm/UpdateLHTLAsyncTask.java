 ...
 */
public class UpdateLHTLAsyncTask extends AsyncTask<Void, Void, LHTL_ett> {
    ...
    public UpdateLHTLAsyncTask(Activity activity, long MaLoaiHinhTL, String TenLoaiHinhTL, long STT, String GhiChu, boolean Active) {
    ...
    protected LHTL_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Update_LHTL";

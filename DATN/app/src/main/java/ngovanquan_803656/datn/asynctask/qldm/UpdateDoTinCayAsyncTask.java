 ...
 */
public class UpdateDoTinCayAsyncTask extends AsyncTask<Void, Void, DoTinCay_ett> {
    ...
    public UpdateDoTinCayAsyncTask(Activity activity, long MaDoTinCay, String TenDoTinCay, String GhiChu, int STT, boolean Active) {
    ...
    protected DoTinCay_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Update_DoTinCay";

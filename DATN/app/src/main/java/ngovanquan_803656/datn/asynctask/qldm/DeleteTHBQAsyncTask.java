 ...
 */
public class DeleteTHBQAsyncTask extends AsyncTask<Void, Void, THBQ_ett> {
    private Activity activity;
    private long MaTHBQ;
    private ProgressDialog progressDialog;
    private THBQ_ett thbq_ett;

    public DeleteTHBQAsyncTask(Activity activity, long MaTHBQ) {
    ...
    protected THBQ_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Delete_THBQ";

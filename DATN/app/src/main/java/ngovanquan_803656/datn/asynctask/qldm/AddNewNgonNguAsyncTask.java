 ...
 */
public class AddNewNgonNguAsyncTask extends AsyncTask<Void, Void, NgonNgu_ett> {
    ...
    public AddNewNgonNguAsyncTask(Activity activity, String TenNN, String GhiChu, int STT, boolean Active) {
    ...
    protected NgonNgu_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Insert_NN";

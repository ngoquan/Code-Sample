 ...
 */
public class SearchVanBan extends AsyncTask<Void, Void, ArrayList<VanBan_ett>> {
    ...
    public SearchVanBan(Activity activity, String search_type, String search_val, int page_current) {
            ...
            if (soapData.hasProperty("Data")) {
                ...
                for (int i = 0; i < soapArr.getPropertyCount(); i++) {
                    ...
                    if (TacGia.equals("anyType{}"))
                        TacGia = "";
                    int MaLVB = 1;
                    if (soapItem.hasAttribute("MaLVB")) {
                        MaLVB = Integer.parseInt(soapItem.getAttribute("MaLVB").toString());
                    }
                    String TrichYeuND = "";
                    ...
                    if (SoLuongTo.equals("anyType{}"))
                        SoLuongTo = "";
                    int MaDoTinCay = 1;
                    if (soapItem.hasProperty("MaDoTinCay") && (soapItem.getProperty("MaDoTinCay") != null))

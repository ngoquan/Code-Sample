 ...
 */
public class UpdateLVBAsyncTask extends AsyncTask<Void, Void, LVB_ett> {
    ...
    public UpdateLVBAsyncTask(Activity activity, long MaLVB, String TenLVB, String GhiChu, int STT, boolean Active) {
    ...
    protected LVB_ett doInBackground(Void... params) {
        try {
            final String METHOD_NAME = "Update_LVB";

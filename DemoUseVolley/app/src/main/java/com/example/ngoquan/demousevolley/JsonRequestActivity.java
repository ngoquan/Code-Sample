...
public class JsonRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void makeJsonObjReq() {
        showProgressDialog();
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Const.URL_JSON_OBJECT, null, new Response.Listener<JSONObject>() {
            @Override
    ...
    private void makeJsonArrayReq() {
        showProgressDialog();
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Const.URL_JSON_ARRAY, new Response.Listener<JSONArray>() {
            @Override
